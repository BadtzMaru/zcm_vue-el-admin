	...
	>
		<el-tabs v-model="activeName">
			<el-tab-pane label="注册与访问" name="first">
				<el-form :model="form" label-width="160px">
					<el-form-item label="是否允许注册会员">
						<el-radio-group v-model="form.isreg" size="mini">
							<el-radio-button :label="1">是</el-radio-button>
							<el-radio-button :label="0">否</el-radio-button>
						</el-radio-group>
					</el-form-item>
					<el-form-item label="注册类型">
						<el-radio-group v-model="form.reg_type" size="mini">
							<el-radio-button label="username"
								>普通注册</el-radio-button
							>
							<el-radio-button label="phone"
								>手机注册</el-radio-button
							>
						</el-radio-group>
					</el-form-item>
					...
					<el-form-item label="强制密码复杂度">
						...
						>
							<el-checkbox-button :label="0"
								>数字</el-checkbox-button
							>
							<el-checkbox-button :label="1"
								>小写字母</el-checkbox-button
							>
							<el-checkbox-button :label="2"
								>大写字母</el-checkbox-button
							>
							<el-checkbox-button :label="3"
								>标点符号</el-checkbox-button
							>
						</el-checkbox-group>
					</el-form-item>
					<el-form-item>
			...
			<el-tab-pane label="Api安全" name="third">
				<el-form :model="form" label-width="160px">
					<el-form-item label="是否开起API安全">
						<el-radio-group v-model="form.api" size="mini">
							<el-radio-button :label="1">是</el-radio-button>
							<el-radio-button :label="0">否</el-radio-button>
						</el-radio-group>
						<small class="text-secondary d-block"
