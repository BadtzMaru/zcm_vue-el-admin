	...
	>
		...
		<el-form ref="form" label-width="100px">
			...
			<el-form-item label="总库存">
				<el-input class="w-25" v-model="form.stock" type="number">
			...
			<el-form-item label="最低销售价">
				<el-input v-model="form.min_oprice" class="w-25" type="number">
					<template slot="append">元</template></el-input
				>
			</el-form-item>
			<el-form-item label="最低原价">
				<el-input v-model="form.min_price" class="w-25" type="number">
					<template slot="append">元</template></el-input
				>
			</el-form-item>
